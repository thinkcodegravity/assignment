...
public class MethodsAll {
	...
	// Create a method that can accept appropriate input for payment webpage and
	...
	// Create a method that can return electricity plan details if provided zip code
	// as the input
	...
	public static String insuranceDetail(int age) {
	    if (age >= 50) {
	        return "Insurance cost per month: $300";
	    } else if (age >= 18) {
	        return "Insurance cost per month: $150";
	    }
	    // No default return statement here
	    // Let the caller handle any other cases
		return "";
	}
	...
	// Create a method that can return user profile if provided customers userid and
	// password as the input
	public static String userProfile(String userId, String password) {
		if (userId != null && password != null) {
			return """
					UserId: 12345,
					UserName: Pawan Lamichhane,
					EmailAddress: 1234 Hello st, Texas, 55255
					""";
		}
		return "";
	}
